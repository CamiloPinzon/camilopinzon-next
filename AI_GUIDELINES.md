...
7. **Flujo de Trabajo IA y Restricción Estricta (Hard Constraint)**: La IA tiene **PROHIBIDO** realizar modificaciones de código, ejecutar comandos de terminal o avanzar al desarrollo de una tarea a menos que el usuario incluya la palabra exacta **"AUTHORIZE"** (o "AUTORIZO") en su prompt. La IA no debe asumir permisos bajo frases genéricas como "actualiza los archivos" o "continúa". Si no está la palabra clave, la IA debe detenerse y pedir autorización explícita.
